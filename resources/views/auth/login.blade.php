        ...
        <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
            <div class="w-full px-8 md:px-32 lg:px-24">
                <form class="bg-white rounded-md shadow-2xl p-5">
                    ...
                    <p class="text-sm font-normal text-gray-600 mb-8">Silahkan masuk untuk berjelajah lebih lanjut!</p>
                    <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-gray" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-gray" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <button type="submit" class="block w-full bg-sky-500 mt-5 py-2 rounded-2xl hover:bg-sky-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Login</button>

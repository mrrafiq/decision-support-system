            ...
            <div class="w-full px-8 md:px-32 lg:px-24">
                <form class="bg-white rounded-md shadow-2xl p-5">
                    ...
                    <div class="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl ">
                        ...
                        <input class="pl-2 w-full outline-none border-none" type="password" name="password-confirm" id="password-confirm" placeholder="Password Confirmation" />
                    </div>
                    ...
                    <div class="flex justify-between mt-4">
                        <a href="/login" class="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Sudah punya akun?</a>
                    </div>
                </form>
            </div>
        </div>

<div
    ...
    <div class="overflow-y-auto overflow-x-hidden flex flex-col flex-grow">
        ...
        <ul class="flex flex-col space-y-1">
            ...
            <li>
                <a href="{{ route('school') }}"
                    class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6 {{ $title == 'School' ? 'border-gray-800 text-white-800 bg-gray-600' : '' }}">
                    <span class="inline-flex justify-center items-center ml-4">
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">School</span>
                </a>
            </li>
            <li>
            ...
            @role('administrator')
                ...
                <li>
                    <a href="{{route('decision-session')}}"
                        class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6 {{ $title == 'Sessions' ? 'border-gray-800 text-white-800 bg-gray-600' : '' }}">
                        <span class="inline-flex justify-center items-center ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                              </svg>
                        </span>
                        <span class="ml-2 text-sm tracking-wide truncate">Session Management</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('user-categories')}}"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">User-Categories</span>
                    </a>
                </li>
                <li>
